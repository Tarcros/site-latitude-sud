...
<header class="ls-header" id="ls-header" role="banner">
  <div class="ls-header-inner">
    ...
    <a href="/site-latitude-sud/index.html" class="ls-logo" aria-label="Latitude Sud — Accueil">
      <img src="/site-latitude-sud/assets/logo-sud.svg" alt="Logo Latitude Sud"
    ...
    <nav class="ls-nav-links" role="navigation" aria-label="Navigation principale">
      <a href="/site-latitude-sud/index.html"  class="ls-nav-link${isActive('accueil')}">Accueil</a>
      <a href="/site-latitude-sud/pages/agence.html" class="ls-nav-link${isActive('agence')}">Agence</a>
      <div class="ls-nav-dropdown" id="ls-dropdown-realisations">
        <a href="/site-latitude-sud/pages/realisations.html"
        ...
        <div class="ls-nav-dropdown-menu" role="menu">
          <a href="/site-latitude-sud/pages/photos.html" role="menuitem">Photos</a>
          <a href="/site-latitude-sud/pages/charte-graphique.html" role="menuitem">Charte graphique</a>
          <a href="/site-latitude-sud/pages/social.html" role="menuitem">Réseaux Sociaux</a>
          <a href="/site-latitude-sud/pages/catalogue.html" role="menuitem">Catalogue</a>
        </div>
      </div>

      <a href="/site-latitude-sud/pages/contact.html" class="ls-nav-link${isActive('contact')}">Contact</a>
    </nav>
    ...
    <div class="ls-nav-right">
      ...
      <a href="/site-latitude-sud/pages/contact.html" class="btn btn-primary btn-arrow ls-header-cta">
        Nous contacter
      </a>
    </div>
...
<nav class="ls-mobile-nav" id="ls-mobile-nav"
  ...
  <a href="/site-latitude-sud/index.html">Accueil</a>
  <a href="/site-latitude-sud/pages/agence.html">Agence</a>
  <a href="/site-latitude-sud/pages/realisations.html">Réalisations</a>
  <a href="/site-latitude-sud/pages/photos.html"       class="ls-mobile-sub">Photos</a>
  <a href="/site-latitude-sud/pages/charte-graphique.html" class="ls-mobile-sub">Charte graphique</a>
  <a href="/site-latitude-sud/pages/social.html"       class="ls-mobile-sub">Réseaux Sociaux</a>
  <a href="/site-latitude-sud/pages/catalogue.html"    class="ls-mobile-sub">Catalogue</a>
  <a href="/site-latitude-sud/pages/contact.html">Contact</a>
  <a href="/site-latitude-sud/pages/contact.html" class="btn btn-primary btn-arrow ls-mobile-cta">
    Nous contacter
  </a>
</nav>
  `.trim();
...
<footer class="ls-footer" role="contentinfo">
  ...
  <div class="ls-footer-inner">
    ...
    <div class="ls-footer-nav-col">
      ...
      <a href="/site-latitude-sud/index.html">Accueil</a>
      <a href="/site-latitude-sud/pages/agence.html">L'agence</a>
      <a href="/site-latitude-sud/pages/realisations.html">Réalisations</a>
      <a href="/site-latitude-sud/pages/contact.html">Contact</a>
    </div>
    ...
    <div class="ls-footer-expertises-col">
      ...
      <a href="/site-latitude-sud/pages/photos.html">Photos</a>
      <a href="/site-latitude-sud/pages/charte-graphique.html">Charte graphique</a>
      <a href="/site-latitude-sud/pages/social.html">Réseaux Sociaux</a>
      <a href="/site-latitude-sud/pages/catalogue.html">Catalogue</a>
    </div>
  ...
  <div class="ls-footer-bottom">
    ...
    <div class="ls-footer-bottom-links">
      <a href="/site-latitude-sud/pages/mentions-legales.html">Mentions légales</a>
      <a href="/site-latitude-sud/pages/politique-de-confidentialite.html">Politique de confidentialité</a>
    </div>
  </div>
...
function initProjectModal() {
  ...
  const renderSocialComposition = (trigger) => {
    ...
    contactCta.className = 'ls-social-contact-cta';
    contactCta.href = '/site-latitude-sud/pages/contact.html';
    contactCta.textContent = 'Nous contacter';
    ctaRow.appendChild(contactCta);
  ...
  const open = (trigger) => {
    const imgs = (trigger.dataset.projectImages || '')
      ...
      .map(source => safeImageSource(source.trim()))
      .filter(Boolean);
    slides = imgs.length ? imgs : ['/site-latitude-sud/backgrounds/image-bg/header-bg-homme.png'];
    ...
    <div class="marina-case-dialog" role="dialog" aria-modal="true" aria-labelledby="marina-case-title">
      ...
      <div class="marina-case-content">
        <header class="marina-case-hero">
          ...
          <img class="marina-case-logo" src="/site-latitude-sud/assets/projects/marina/logo-blue-transparent.webp" alt="Logo bleu de la Marina Bas-du-Fort" loading="lazy">
        </header>

        <section class="marina-case-section">
          <h3>Avant &amp; après</h3>
          <div class="marina-before-after">
            <figure><figcaption><span>Avant</span></figcaption><img src="/site-latitude-sud/assets/projects/marina/logo-before.webp" alt="Ancienne identité de la Marina Bas-du-Fort" loading="lazy"></figure>
            <span class="marina-before-after-arrow" aria-hidden="true">&rarr;</span>
            <figure class="marina-after-logo"><figcaption><span>Après</span></figcaption><img src="/site-latitude-sud/assets/projects/marina/logo-after.webp" alt="Nouvelle identité blanche de la Marina Bas-du-Fort sur fond bleu" loading="lazy"></figure>
          </div>
        </section>
        ...
        <section class="marina-case-section">
          ...
          <div class="marina-dossier-grid">
            <figure class="marina-media-card marina-media-card--wide"><img src="/site-latitude-sud/assets/projects/marina/charte-foundations.webp" alt="Construction du logo, variantes chromatiques, typographies et palette de la Marina Bas-du-Fort" loading="lazy"></figure>
          </div>
        </section>
        ...
        <section class="marina-case-section">
          ...
          <div class="marina-system-grid marina-system-grid--single">
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/charte-format-square.webp" alt="Présentation du système de composition au format carré" loading="lazy"></figure>
          </div>
        </section>
        ...
        <section class="marina-case-section">
          ...
          <div class="marina-deployment-grid">
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/marina-equipe-accueil.webp" alt="Mockup de l'identité Marina Bas-du-Fort sur la tenue et le badge de l'équipe d'accueil" loading="lazy"><figcaption>Équipe d'accueil</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/marina-kit-visiteur.webp" alt="Mockup d'un kit visiteur Marina Bas-du-Fort" loading="lazy"><figcaption>Kit visiteur</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-plan-orientation.webp" alt="Mockup du plan d'orientation de la Marina Bas-du-Fort" loading="lazy"><figcaption>Plan d'orientation</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-signaletique.webp" alt="Mockup de la signalétique de la Marina Bas-du-Fort" loading="lazy"><figcaption>Signalétique directionnelle</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-guide-port.webp" alt="Mockup du guide de port de la Marina Bas-du-Fort" loading="lazy"><figcaption>Guide de port</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-borne-digitale.webp" alt="Mockup de la borne digitale de la Marina Bas-du-Fort" loading="lazy"><figcaption>Borne d'information</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-polo-equipe.webp" alt="Mockup du polo de l'équipe de la Marina Bas-du-Fort" loading="lazy"><figcaption>Tenue d'équipe</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-drapeaux.webp" alt="Mockup des drapeaux de la Marina Bas-du-Fort" loading="lazy"><figcaption>Drapeaux d'accueil</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-badge-acces.webp" alt="Mockup du badge d'accès de la Marina Bas-du-Fort" loading="lazy"><figcaption>Badge d'accès</figcaption></figure>
            <figure class="marina-media-card"><img src="/site-latitude-sud/assets/projects/marina/mockups/generated/marina-poloshirts.webp" alt="Mockup des polos de la Marina Bas-du-Fort" loading="lazy"><figcaption>Collection textile</figcaption></figure>
          </div>
        </section>
      </div>
    </div>`;
    ...
    <div class="so-class-dialog" role="dialog" aria-modal="true" aria-labelledby="so-class-title">
      ...
      <div class="so-class-content">
        <header class="so-class-hero">
          ...
          <img src="/site-latitude-sud/assets/projects/so-class/gallery/so-class-collection-jazz-cover-clean-2022.webp" alt="Couverture de la collection Jazz de So Class" loading="eager">
        </header>
          ...
          <div class="so-class-instagram-grid">
            ${[1, 2, 3, 4].map((index) => `
              <article class="so-class-instagram-post">
                <header><img class="so-class-avatar" src="/site-latitude-sud/assets/projects/so-class/profile/instagram-profile-so-class-2022.webp" alt=""><div><strong>soclass971</strong><small>Guadeloupe</small></div><b>•••</b></header>
                <img src="/site-latitude-sud/assets/projects/so-class/instagram/so-class-instagram-collection-jazz-2022-${String(index).padStart(2, '0')}.webp?v=4" alt="Publication Instagram So Class, collection Jazz ${index}" loading="lazy">
                <footer>
        ...
        <section class="so-class-section">
          ...
          <div class="so-class-gallery">
            <figure class="so-class-gallery__wide"><img src="/site-latitude-sud/assets/projects/so-class/gallery/so-class-shooting-eglise-pap-fiona-2022.webp" alt="Fiona avec lunettes devant l'église à Pointe-à-Pitre" loading="lazy"></figure>
          </div>
          ...
          <div class="so-class-product-spreads">
            <article class="so-class-product-spread">
              <figure class="so-class-product-model"><img src="/site-latitude-sud/assets/projects/so-class/gallery/so-class-portrait-homme-lunettes-2022.webp" alt="Portrait homme portant une monture Jazz" loading="lazy"></figure>
              <div class="so-class-product-pair">
                <article class="so-class-product-item">
                  <figure><img src="/site-latitude-sud/assets/projects/so-class/products/so-class-lunettes-noir-transparent.webp?v=4" alt="Monture Jazz noire et transparente" loading="lazy"></figure>
                ...
                <article class="so-class-product-item">
                  <figure><img src="/site-latitude-sud/assets/projects/so-class/products/so-class-lunettes-ecaille.webp?v=4" alt="Monture Jazz écaille" loading="lazy"></figure>
            ...
            <article class="so-class-product-spread so-class-product-spread--reverse">
              <div class="so-class-product-pair">
                <article class="so-class-product-item">
                  <figure><img src="/site-latitude-sud/assets/projects/so-class/products/so-class-lunettes-bleu-rouge.webp?v=4" alt="Monture Jazz bleue et rouge" loading="lazy"></figure>
                ...
                <article class="so-class-product-item">
                  <figure><img src="/site-latitude-sud/assets/projects/so-class/products/so-class-lunettes-blanc-ecaille.webp?v=4" alt="Monture Jazz blanche et écaille" loading="lazy"></figure>
              ...
              <figure class="so-class-product-model"><img src="/site-latitude-sud/assets/projects/so-class/gallery/so-class-portrait-femme-lunettes-2022.webp" alt="Portrait femme portant une monture Jazz" loading="lazy"></figure>
            </article>
          </div>
          <div class="so-class-gallery so-class-gallery--closing">
            <figure class="so-class-gallery__wide"><img src="/site-latitude-sud/assets/projects/so-class/gallery/so-class-portrait-fiona-pap-2022.webp" alt="Portrait Fiona avec lunettes à Pointe-à-Pitre" loading="lazy"></figure>
            <figure class="so-class-gallery__wide"><img src="/site-latitude-sud/assets/projects/so-class/gallery/so-class-brochure-mockup-jazz-2022.webp" alt="Mockup brochure So Class collection Jazz" loading="lazy"></figure>
          </div>
        </section>
      </div>
    </div>`;
    ...
    <div class="cist-case-dialog" role="dialog" aria-modal="true" aria-labelledby="cist-case-title">
      ...
      <div class="cist-case-content">
        <header class="cist-case-hero">
          ...
          <img class="cist-case-logo" src="/site-latitude-sud/assets/projects/cist/logo-vertical.webp" alt="Logo CIST, ma santé au travail" loading="eager">
        </header>
        ...
        <section class="cist-case-section">
          ...
          <div class="cist-before-after">
            <figure><figcaption>Avant</figcaption><img src="/site-latitude-sud/assets/projects/cist/logo-before.webp" alt="Ancienne version monochrome du logo CIST" loading="lazy"></figure>
            <span class="cist-before-after-arrow" aria-hidden="true">&rarr;</span>
            <figure><figcaption>Après</figcaption><img src="/site-latitude-sud/assets/projects/cist/logo-horizontal.webp" alt="Nouvelle identité horizontale colorée du CIST" loading="lazy"></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section">
          ...
          <div class="cist-logo-grid">
            <figure class="cist-media-card cist-media-card--logo"><img src="/site-latitude-sud/assets/projects/cist/logo-vertical.webp" alt="Version verticale du logo CIST" loading="lazy"><figcaption><strong>Version principale</strong><span>La version verticale est la représentation prioritaire de l'image du CIST.</span></figcaption></figure>
            <figure class="cist-media-card cist-media-card--logo"><img src="/site-latitude-sud/assets/projects/cist/logo-horizontal.webp" alt="Version horizontale du logo CIST" loading="lazy"><figcaption><strong>Version horizontale</strong><span>Elle assure une lisibilité optimale sur les formats larges et les espaces restreints en hauteur.</span></figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section cist-case-section--tinted">
          ...
          <div class="cist-branch-grid">
            <figure class="cist-branch-card"><img src="/site-latitude-sud/assets/projects/cist/branch-suivi.webp" alt="Déclinaison verte du CIST" loading="lazy"><figcaption><strong>Suivi individuel</strong><span>Une version monochrome verte dédiée à l'accompagnement personnalisé des salariés et au suivi médical.</span></figcaption></figure>
            <figure class="cist-branch-card"><img src="/site-latitude-sud/assets/projects/cist/branch-risque.webp" alt="Déclinaison bleu bien-être du CIST" loading="lazy"><figcaption><strong>Risque professionnel</strong><span>Le bleu traduit la rigueur, la confiance et l'engagement dans la protection de la santé au travail.</span></figcaption></figure>
            <figure class="cist-branch-card"><img src="/site-latitude-sud/assets/projects/cist/branch-maintien.webp" alt="Déclinaison bleu institutionnel du CIST" loading="lazy"><figcaption><strong>Maintien de l'emploi</strong><span>Le bleu institutionnel exprime la stabilité, le soutien et la continuité professionnelle.</span></figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section">
          ...
          <div class="cist-guideline-grid">
            <figure><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-zone-protection-horizontal.webp" alt="Zone de protection de la version horizontale du logo CIST" loading="lazy"><figcaption><strong>Zone de protection horizontale</strong><span>La hauteur de la baseline sert d'unité X et définit un espace libre identique sur les quatre côtés.</span></figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-zone-protection-vertical.webp" alt="Zone de protection de la version verticale du logo CIST" loading="lazy"><figcaption><strong>Zone de protection verticale</strong><span>L'espace entre le pictogramme et le mot « cist » devient l'unité de respiration minimale.</span></figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-logo-taille-minimale-horizontal.webp" alt="Taille minimale de la version horizontale du logo CIST" loading="lazy"><figcaption><strong>Version horizontale</strong><span>20 mm en impression ou 120 pixels à l'écran pour garantir la lisibilité.</span></figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-logo-taille-minimale-vertical.webp" alt="Taille minimale de la version verticale du logo CIST" loading="lazy"><figcaption><strong>Version verticale</strong><span>15 mm en impression ou 80 pixels à l'écran ; sous cette taille, le pictogramme seul est recommandé.</span></figcaption></figure>
            <figure class="cist-guideline-grid__wide"><div class="cist-prohibited-logo-grid"><span class="cist-prohibited-item"><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-usage-interdit-couleurs.webp" alt="Couleurs non validées pour le logo CIST" loading="lazy"></span><span class="cist-prohibited-item"><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-usage-interdit-proportions.webp" alt="Logo CIST déformé à ne pas utiliser" loading="lazy"></span><span class="cist-prohibited-item"><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-usage-interdit-inclinaison.webp" alt="Logo CIST incliné à ne pas utiliser" loading="lazy"></span></div><figcaption><strong>Préserver l'intégrité du logo</strong><span>Ne pas modifier les couleurs, déformer l'ensemble, ajouter des effets ou utiliser un fond insuffisamment contrasté.</span></figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section cist-case-section--tinted">
          ...
          <div class="cist-symbol-layout">
            <figure><img src="/site-latitude-sud/assets/projects/cist/logo-icon.webp" alt="Icône cœur du CIST" loading="lazy"><figcaption>Le cœur devient avatar, favicon ou repère dans les petits espaces.</figcaption></figure>
            <figure class="cist-icon-system"><img src="/site-latitude-sud/assets/projects/cist/guidelines/cist-systeme-pictogrammes.webp" alt="Système complet de pictogrammes linéaires du CIST" loading="lazy"><figcaption>Une bibliothèque cohérente couvre la santé, la prévention, l'accompagnement, les services et les environnements de travail.</figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section">
          ...
          <div class="cist-photo-grid">
            <figure class="cist-photo-grid__wide"><img src="/site-latitude-sud/assets/projects/cist/photo-consultation.webp" alt="Salariée en échange avec un professionnel de santé" loading="lazy"><figcaption><strong>Écoute et dialogue</strong><span>Des situations réelles, des attitudes bienveillantes et une proximité humaine.</span></figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/cist/photo-accompagnement.webp" alt="Professionnel de santé accompagnant un salarié" loading="lazy"><figcaption><strong>Accompagnement</strong><span>La confiance au cœur de la relation entre le salarié et le professionnel.</span></figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/cist/photo-ecoute.webp" alt="Consultation de santé au travail" loading="lazy"><figcaption><strong>Suivi individuel</strong><span>Une présence attentive dans un environnement clair et naturel.</span></figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/cist/photo-prevention-collective.webp" alt="Intervention de prévention devant un public" loading="lazy"><figcaption><strong>Prévention en entreprise</strong><span>Informer, alerter et accompagner les collectifs de travail.</span></figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/cist/photo-dialogue.webp" alt="Échange entre une médecin et une salariée" loading="lazy"><figcaption><strong>Proximité</strong><span>Une photographie positive, accessible et ancrée dans le quotidien.</span></figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section cist-case-section--applications">
          ...
          <div class="cist-application-grid">
            <figure class="cist-application-card cist-application-card--wide"><img src="/site-latitude-sud/assets/projects/cist/mockup-business-cards.webp" alt="Cartes de visite du CIST mises en situation" loading="lazy"><figcaption><strong>Cartes de visite</strong><span>Un format horizontal, lisible et institutionnel.</span></figcaption></figure>
            <figure class="cist-application-card"><img src="/site-latitude-sud/assets/projects/cist/mockup-stationery.webp" alt="Papeterie institutionnelle du CIST" loading="lazy"><figcaption><strong>Papeterie</strong><span>Une grille claire pour les documents administratifs.</span></figcaption></figure>
            <figure class="cist-application-card"><img src="/site-latitude-sud/assets/projects/cist/mockup-event-rollup.webp" alt="Oriflamme CIST dans un événement professionnel en Guadeloupe" loading="lazy"><figcaption><strong>Événementiel</strong><span>Un support visible qui exprime proximité et expertise.</span></figcaption></figure>
          </div>
          <div class="cist-social-heading">
            <span>Applications digitales</span>
            <h4>Des publications cohérentes et accessibles</h4>
          </div>
          <div class="cist-social-showcase">
            <article class="cist-social-post">
              <header><img src="/site-latitude-sud/assets/projects/cist/logo-icon.webp" alt=""><div><strong>cist971</strong><span>Guadeloupe</span></div><b>•••</b></header>
              <img src="/site-latitude-sud/assets/projects/cist/application-instagram.webp" alt="Publication Instagram du CIST" loading="lazy">
        ...
        <section class="cist-case-section cist-case-section--tinted">
          ...
          <div class="cist-motion-video"><iframe src="https://www.youtube-nocookie.com/embed/CBANvHPZRgY?autoplay=1&amp;mute=1&amp;loop=1&amp;playlist=CBANvHPZRgY&amp;playsinline=1&amp;rel=0" title="Motion design CIST 971" loading="lazy" referrerpolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        </section>
      </div>
    </div>`;
  document.body.appendChild(modal);
    ...
    <div class="cist-case-dialog bonnes-case-dialog" role="dialog" aria-modal="true" aria-labelledby="bonnes-case-title">
      ...
      <div class="cist-case-content">
        <header class="cist-case-hero bonnes-case-hero">
          ...
          <img class="cist-case-logo bonnes-case-logo" src="/site-latitude-sud/assets/projects/bonnes-epices/logo-after.webp" alt="Nouvelle identité Les Bonnes Épices de Monsieur Maurice" loading="eager">
        </header>
        ...
        <section class="cist-case-section">
          ...
          <div class="bonnes-evolution-grid">
            <figure><img src="/site-latitude-sud/assets/projects/bonnes-epices/logo-before.webp" alt="Ancienne identité Les Bonnes Épices avec la signature Guadeloupe French West Indies" loading="lazy"><figcaption><span>Avant</span> Un emblème illustré et très détaillé</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/bonnes-epices/logo-after.webp" alt="Nouvelle identité Les Bonnes Épices en jaune sur fond vert" loading="lazy"><figcaption><span>Après</span> Une signature plus directe et plus lisible</figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section bonnes-case-section--yellow">
          ...
          <div class="bonnes-system-grid">
            <figure><img src="/site-latitude-sud/assets/projects/bonnes-epices/presentation/bonnes-epices-information.webp" alt="Présentation du système d'information produit" loading="lazy"></figure>
            <figure><img src="/site-latitude-sud/assets/projects/bonnes-epices/presentation/bonnes-epices-histoire-systeme.webp" alt="Déclinaisons éditoriales autour de l'histoire des épices" loading="lazy"></figure>
            <figure><img src="/site-latitude-sud/assets/projects/bonnes-epices/presentation/bonnes-epices-recette-systeme.webp" alt="Système graphique appliqué à une recette" loading="lazy"></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section">
          ...
          <div class="bonnes-application-grid">
            <figure class="bonnes-application-grid__wide"><img src="/site-latitude-sud/assets/projects/bonnes-epices/presentation/bonnes-epices-recette-declinaisons.webp" alt="Déclinaison d'une recette Les Bonnes Épices" loading="lazy"><figcaption>Édition recette</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/bonnes-epices/presentation/bonnes-epices-cartes-visite.webp" alt="Recto et verso de la carte de visite Les Bonnes Épices" loading="lazy"><figcaption>Carte de visite</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/bonnes-epices/presentation/bonnes-epices-instagram.webp" alt="Mise en situation du compte Instagram Les Bonnes Épices" loading="lazy"><figcaption>Déploiement Instagram</figcaption></figure>
          </div>
        </section>
      </div>
    </div>`;
    ...
    <div class="cist-case-dialog smgeag-case-dialog" role="dialog" aria-modal="true" aria-labelledby="smgeag-case-title">
      ...
      <div class="cist-case-content">
        <header class="cist-case-hero smgeag-case-hero">
          ...
          <img class="cist-case-logo smgeag-case-logo" src="/site-latitude-sud/assets/projects/smgeag/logo-baseline-transparent.webp" alt="Logo SMGEAG, Eaux de Guadeloupe" loading="eager">
        </header>
        ...
        <section class="cist-case-section cist-case-section--tinted smgeag-case-section--tinted">
          ...
          <div class="smgeag-icon-grid">
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/icon-primary-trim.webp" alt="Icône principale du SMGEAG" loading="lazy"><figcaption>Bleu &amp; bleu ciel</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/icon-hussard-trim.webp" alt="Variante bleu hussard de l'icône" loading="lazy"><figcaption>Bleu de hussard</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/icon-silver-trim.webp" alt="Variante gris argent de l'icône" loading="lazy"><figcaption>Gris argent &amp; bleu ciel</figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section">
          ...
          <div class="smgeag-logo-grid">
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/logo-horizontal.webp" alt="Version horizontale du logo SMGEAG" loading="lazy"><figcaption>Version horizontale</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/logo-bicolor-light.webp" alt="Version bicolore sur fond clair" loading="lazy"><figcaption>Bicolore sur fond clair</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/logo-bicolor-blue.webp" alt="Version bicolore sur fond bleu" loading="lazy"><figcaption>Bicolore sur fond bleu</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/logo-mono-dark.webp" alt="Version monochrome sur fond sombre" loading="lazy"><figcaption>Monochrome</figcaption></figure>
          </div>
        </section>
        ...
        <section class="cist-case-section cist-case-section--applications">
          <div class="cist-section-heading">
            ...
            <p>Le système place l'eau, la proximité et la confiance au premier plan. Il s'applique ici à des outils réellement utilisés sur le terrain : véhicule d'intervention, tenue technique et matériel de contrôle de la qualité de l'eau.</p>
          </div>
          <div class="smgeag-showcase-grid">
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/mockups/smgeag-vehicule-intervention.webp" alt="Mockup d'un véhicule d'intervention SMGEAG" loading="lazy"><figcaption>Véhicule d'intervention</figcaption></figure>
            <figure><img src="/site-latitude-sud/assets/projects/smgeag/mockups/smgeag-equipement-terrain.webp" alt="Mockup des équipements terrain du SMGEAG" loading="lazy"><figcaption>Équipement terrain</figcaption></figure>
          </div>
        </section>
      </div>
    </div>`;
...
function initCaseStudyContactCtas() {
  ...
  document.querySelectorAll('[role="dialog"][aria-modal="true"]').forEach((dialog) => {
    if (dialog.querySelector('a[href="/site-latitude-sud/pages/contact.html"]')) return;
    ...
    footer.innerHTML = `
      ...
      <a href="/site-latitude-sud/pages/contact.html">Nous contacter <span aria-hidden="true">→</span></a>`;
...
function initPageTransition() {
  ...
  curtain.innerHTML = '<img src="/site-latitude-sud/assets/icons/ui/icon-ui-cocotier.svg" alt="" width="56" height="56">';
